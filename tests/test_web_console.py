...
class WebConsoleTests(unittest.TestCase):
    ...
    def test_static_traversal_and_legacy_config_routes_are_absent(self):
        ...
        self.assertIn('className: "queue-operation-log"', script.text)
        self.assertIn('role: "log"', script.text)
        self.assertIn("captureQueueLogView", script.text)
        self.assertNotIn("function queueStageGrid", script.text)
        self.assertIn(".queue-operation-log", style.text)
